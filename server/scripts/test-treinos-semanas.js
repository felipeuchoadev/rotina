...
assert.match(html,/treinoSemanaSel=i;/);
assert.doesNotMatch(html,/treinoSemanaSel=i; treinoDiaSel='seg'/);
...
assert.match(html,/class="training-week-hero"/);
assert.match(html,/semanaAtual\?\.descricao/);
assert.match(html,/class="training-media"/);
