...
assert.doesNotMatch(html, /gruposPorNome\.get\(chaveG\)/, 'Pastas internas homônimas não podem ser unidas automaticamente');
assert.match(html, /Nomes iguais são válidos/, 'Cada pasta repetida deve manter identidade e posição próprias');
