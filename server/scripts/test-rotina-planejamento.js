...
assert.match(html,/function expandirRepeticoesRotina/);
assert.match(html,/Repetições encontradas automaticamente/);
assert.match(html,/Apagar automaticamente todas as \$\{todos\.length\} ocorrências/);
